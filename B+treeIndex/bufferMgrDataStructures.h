...
/*
 * bufferMgrDataStructures.h
 */

//This is a Frame's structure.It is present on the RAM.
typedef struct frame
{
		char frameData[PAGE_SIZE + 1]; 
		struct frame *nextFramePtr;
}frameList;


//This function maps to store PageFrameNumber and the its corresponding discPageNumber;
